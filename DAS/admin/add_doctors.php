<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if(empty($_POST['specility'])){
            $err['specility'] = "enter specility";
            $error ++;
        }else{
        ...
        if($error == 0){
            ...
            $sql = "INSERT INTO `doctor` (`fname`, `email`, `specility`, `phone`, `image`,`password`) VALUES ('$fname','$email', '$specility','$phone', '$image', '$password')";
        ...
        <div class="main">
            ...
            <div class="container">
                <form action="#" name="register" method="post">
                    ...
                    <div class="input-group">
                        <label for="doctor">Select Specilities:</label><br>
                        <input type="text" id="specility" name="specility" placeholder="Enter Specility" value="<?php echo isset($specility) ? $specility : ''; ?>">
                        <span><?php echo isset($err['specility'])? $err['specility']: '' ?></span>
                    </div><br>
