<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if($error == 0){
            ...
            $sql = "INSERT INTO `session`(`title`, `doctor`, `patients`, `time`, `date`) VALUES ('$title','$doctor',' $patients','$time','$date')";
            ...
            header('location: ../admin/schedule.html');
        }
    }
?>
<!DOCTYPE html>
            ...
            <div class="container">
                <form action="#" name="add_session" method="post">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" id="patients" name="patients" value="<?php echo isset($patients) ? $patients:''; ?>">
