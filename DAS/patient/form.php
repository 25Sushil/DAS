        ...
        <section class="main">
            ...
            <div class="container">
                ...
                <form action="#" method="post">
                    ...
                    <div class="input-group">
                        <input type="text" id="title" placeholder="Give your reason">
                        <span id="err_name"></span>
                    </div> 
                    ...
                    <div class="input-group">
                        <select id="doctor" required>
                            ...
                            <option value="1">Dr. Shirapa Bajrachaya (Dermatologist)</option>
                            <option value="2">Dr. Yadab Dhakal (Pediatrician)</option>
                            <option value="3">Dr. Praniti Singh (Nutritionist/Dietitian)</option>
                            <option value="4">Dr. Shelly Shrestha (Physiotherapist)</option>
                            <option value="5">Dr. Suresh Lamichhane (Anaesthesiologist)</option>
                            <option value="6">Dr. Suraj Kumar Gupta (Chest Physician)</option>
                            <option value="7">Dr. Nidesh Sapkota (Neuropsychiatrist , Dementia Specialist)</option>
                            <option value="8">Dr. Banira karki (Breast Oncosurgeon)</option>
                            <option value="9">Dr. Dina Shrestha (Endocrinologist)</option>
                            <option value="10">Dr. Narayan Thapa (Urologist)</option>
